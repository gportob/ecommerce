...
try {
    ...
    // Meta tags
    $metaTags = [
        'title' => 'Meu Carrinho | Essence',
        'description' => 'Revise seu carrinho de compras',
        'image' => '',
        'url' => isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http' . '://' . $_SERVER['HTTP_HOST'] . '/carrinho'
    ];
    ...
    // Processar itens e decodificar stock
    $cartItems = [];
    ...
    die('<div class="alert alert-danger mt-5 text-center" role="alert">Erro ao carregar carrinho. <a href="/">Voltar à loja</a></div>');
}
?>

<main class="carrinho-page py-5">
    <div class="container">
        <h1 class="h2 fw-light mb-4">Meu Carrinho</h1>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm sticky-top" style="top: 20px;">
                        <div class="card-body">
                            <h5 class="card-title mb-4">Resumo do Carrinho</h5>
...
<script>
            ...
            try {
                ...
                if (data.success) {
                    ...
                    setTimeout(() => {
                        ...
                        // Se não houver mais itens, recarregar
    ...
    document.getElementById('btnCheckout').addEventListener('click', function() {
        alert('Sistema de pagamento será implementado em breve!');
        // Futuramente redirecionar para página de checkout
    });
</script>
